<template>
  <div class="main-container">
    ...
    <div class="tip">
      ...
      <p>开源不易，同时如果需要以下功能，作者提供以下捐赠服务，进群后咨询作者！或者进群后直接扫码支付，联系群主提供支付凭证即可！</p>
      <p class="m-5"><b>（作者8年phper，前端水平一般，不接外包，除非价格确实高，功能也不难！）</b></p>
      <p>1. 后端协助部署：<b>200元/次</b>（提供远程 [todesk] 技术指导，赠送API文档[编写中...]。需要自行安装好运行环境，最好是宝塔面板）</p>
      <p>2. uniapp移动端源码：<b> 388元/套。</b>(全开源，仅提供源码，有源码结构文档，不提供专业指导和部署)</p>
      <p>3. webRTC中继（turn）服务器：原则上参考底部的教程链接来自行安装，如不懂服务器，并且实在是需要作者协助的，同样是<b> 200元/次 </b>(此服务跟部署后端是分开的，毕竟这个东西不是自己的产品)</p>
    </div>
