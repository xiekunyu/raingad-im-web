<template>
  <div class="main-container">
    ...
    <div class="tip">
      ...
      <p>1. 服务端协助部署：<b>200元/次</b>（提供远程 [todesk] 技术指导，赠送API文档[编写中...]。需要自行安装好运行环境，最好是宝塔面板）</p>
      <p>2. uniapp移动端源码：<b> 388元/套。</b>(全开源，仅提供源码，有源码结构文档，不提供专业指导和部署，源码仅供学习使用，不可对源码进行二次售卖)</p>
